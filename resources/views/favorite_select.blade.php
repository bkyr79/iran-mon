...
@section('header')
  <div class="deletepage-title">お気に入り選択ページ</div>
  <div class="acc-menu">
...
@section('content')
  <div>
    <button type="submit" form="fav_form" class="dele-btn">確定する</button>
  </div>
  </div>
  <!-- ↓formタグはループの外に記述する -->
  <form action="/favorite_decided" id="fav_form" method="post">
